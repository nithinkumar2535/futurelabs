...
function LessPricePackages() {
  ...
  const fetchCategories = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/category/lessPrice/get`, { withCredentials: true });
  ...
  const addCategory = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_URL}/api/v1/category/lessPrice/upload`,
  ...
  const toggleCategorySelection = async (id, currentState) => {
    try {
      ...
      const response = await axios.patch(
        `${import.meta.env.VITE_BACKEND_URL}/api/v1/category/lessPrice/update/${id}`,
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Less Price & More Tests</h1>
...
export default LessPricePackages
